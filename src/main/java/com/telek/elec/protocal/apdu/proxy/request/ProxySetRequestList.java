 ...
 */
@Data
public class ProxySetRequestList extends ResTypeCodecAPDU implements Proxy {
     ...
     * 个数
     */
    private List<ProxySetListItem> items = new ArrayList<>();
    /**
     * 1 字节时间标签
     */
    ...
    public ProxySetRequestList() {
        super(APDUResType.PROXY_SET_LIST);
    ...
    protected void decodeSpecialHexToThis(String hexString) throws DecodeException {
        ...
        for (int i = 0; i < size; i++) {
            ProxySetListItem proxyGetListItem = new ProxySetListItem();
    ...
    protected String encodeThisSpecialToHex() throws EncodeException {
        ...
        for (ProxySetListItem item : items) {
